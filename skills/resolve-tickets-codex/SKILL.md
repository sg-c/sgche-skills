...
1. Verify every native child is closed, the target worktree is clean, and the parent remains open. Locate the registered worktree checked out on `main`; require it to be clean and distinct from `targetWorktree`.
